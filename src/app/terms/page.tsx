    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold mb-4 text-foreground">2. User Conduct</h2>
                    <p>
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold mb-4 text-foreground">4. Disclaimer of Warranties</h2>
                    <p>
